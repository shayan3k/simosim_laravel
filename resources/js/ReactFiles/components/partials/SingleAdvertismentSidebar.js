...
export default function SingleAdvertismentSidebar(props) {
    return (
        <div className={props.className}>
            <img className="ad1-image w-100 px-0 border" src={BannerSm1} />

            <img className="ad1-image w-100 px-0 border" src={BannerSm2} />

            <img className="ad1-image w-100 px-0 border" src={BannerSm3} />
            <img className="ad1-image w-100 px-0 border" src={BannerSm4} />
        </div>
    );
}
