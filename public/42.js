...
function index() {
  var baseUrl = "http://127.0.0.1:8000/api";
  var commentsAllAdmin = process.env.MIX_MIX_ADVERTISMENT_SHOWALL;

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(["sfjbfaj"]),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_3___default()({
      ...
      console.log(res); // setComments(res.data);
    })["catch"](function (e) {
